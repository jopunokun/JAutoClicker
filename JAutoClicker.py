    ...
    def on_key_press(self, key):
        ...
        #BINDING KEY
            ...
            if key == Key.esc:
                ...
                self.keybind_input.config(text=self.keybind_old, fg='white')
                self.keyboard_keybind_input.config(text=self.keybind_old, fg='white')
                self.keybind_old = self.keybind_old.lower()
                self.keybind = self.keybind_old
                if self.keybind_old.startswith('Key.'):
                    self.keybind = eval(self.keybind_old)
                else:
                    self.keybind = self.keybind_old.replace("'", "")
                    self.keybind = KeyCode.from_char(self.keybind)
